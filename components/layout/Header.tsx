...
const navLinks: NavLink[] = [
  ...
  { label: "Services", href: "#", dropdown: "services", items: services },
  { label: "Resources", href: "#", dropdown: "resources", items: resources },
            ...
            {navLinks.map((link) =>
              link.dropdown ? (
                <div key={link.label}>
                  <button
                    onClick={() =>
                      setMobileDropdown(mobileDropdown === link.dropdown ? null : link.dropdown!)
                    }
