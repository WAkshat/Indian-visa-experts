...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: `${baseUrl}/india-visa-finder`, priority: 0.8 },
    { url: `${baseUrl}/frro-registration-deadline-calculator`, priority: 0.8 },
    { url: `${baseUrl}/india-visa-types`, priority: 0.8 },
    { url: `${baseUrl}/india-immigration-statistics`, priority: 0.7 },
